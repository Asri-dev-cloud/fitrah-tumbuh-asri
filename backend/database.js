...
function readJsonDb() {
  ...
  if (!fs.existsSync(dbJsonPath)) {
    const initialDb = {
      programs: [
        { id: 1, title: 'Literasi Numerasi Menyenangkan', description: 'Pendekatan belajar membaca, menulis, dan berhitung yang menyenangkan dan kontekstual.', image_url: '/calistung.png', sort_order: 1 },
